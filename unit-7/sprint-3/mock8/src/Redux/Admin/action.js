...
const getAllData = (dispatch) => {
    ...
    axios
        .get("https://server-mock-pmja.onrender.com/movies")
        .then((res) => {
...
const addData = (newData) => (dispatch) => {
    ...
    return axios
        .post("https://server-mock-pmja.onrender.com/movies", newData)
        .then(() => {
...
const updateData = (id, editData) => (dispatch) => {
    ...
    return axios
        .patch(`https://server-mock-pmja.onrender.com/movies/${id}`, editData)
        .then((res) => {
...
const deleteData = (id) => (dispatch) => {
    ...
    return axios
        .delete(`https://server-mock-pmja.onrender.com/movies/${id}`)
        .then(() => {
